...
function CommandDeck({ inProgress, todayTasks, overdue, delivery, waiting, review, backlog, projects, onOpen, onViewChange }: { inProgress: ActionRecord[]; todayTasks: ActionRecord[]; overdue: ActionRecord[]; delivery: DeliverySignals; waiting: ActionRecord[]; review: ActionRecord[]; backlog: ActionRecord[]; projects: ProjectSummary[]; onOpen: (action: ActionRecord) => void; onViewChange: (view: View) => void }) {
